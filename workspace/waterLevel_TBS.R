...
#Date: 6/3/2020 (2/17/2021)
#Purpose: Analysis of initial WL data for Tanglewood
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
pt_files <- list.files(paste0(data_dir, "20210127export"), full.names =  TRUE)
baro_files <- pt_files[str_detect(pt_files, "ba")] #searches for "ba" in the files (NOT CAP)
field_files <- paste0(data_dir, 'well_log1.csv')
...
#THIS IS ALL FUNCTIONAL TO HERE ---
